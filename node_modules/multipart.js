...
function multipart (req, options) {
  ...
  if (type === 'form-data') {
    options.multipart = formdata.generate(options)
  }
...
function setContentType (options, boundary, type) {
  ...
  options.headers.set('content-type', header)
}

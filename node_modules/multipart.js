...
function multipart (req, options) {
  ...
  setContentType(options, chunked, boundary, type)
...
function setContentType (options, chunked, boundary, type) {
  var header = options.headers['content-type']
